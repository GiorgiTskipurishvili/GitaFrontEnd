...
//   // დეფოლტ სია — page=1, რომ MoviePage-ს არ დაემთხვეს
//   useEffect(() => {
//     if (search) return;
...
//       .then((data) =>
//         setShows(
//           data.slice(0, 12).map((s: Show) => ({ ...s, type: "TV Series" }))
//         )
//       );
//   }, [search]);
...
//         {search ? `Found ${shows.length} results for '${search}'` : "TV Series"}
//       </h1>
...
//                 >
//                   <img src={isSaved ? ActiveSaveIcon : SaveIcon} alt="save" />
//                 </button>
//               </div>
...
//                 <span>·</span>
//                 <img src={TvIcon} alt="tv" className="w-4 h-4" />
//                 <span>TV Series</span>
//                 <span>·</span>
              ...
              <article key={show.id} className="min-w-0">
                ...
                <div className="relative group">
                  ...
                  <button
                    onClick={() => toggleSave(show)}
                    aria-label={
                      isSaved ? "Remove from saved" : "Save TV series"
                    }
                    className="
                      absolute
                      top-2
                ...
                >
                  ...
                  <img src={TvIcon} alt="" className="w-[10px] h-[10px]" />
