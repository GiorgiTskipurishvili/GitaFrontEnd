...
export default function SaturnPage() {
  ...
  const planet = data.find((planet) => planet.name === "Saturn");
      ...
      <div className="planet-container">
        <div className="introduce-container">
          <div className="planet-img__container">
            {activeTab === "overview" && <img src={Saturn} alt="" />}
            {activeTab === "structure" && (
              <>
                <img src={Saturn} alt="" className="planet-image" />
                <img src={SaturnInternal} alt="" className="internal-saturn" />
              </>
            )}
            ...
            {activeTab === "geology" && (
              <>
                <img src={Saturn} alt="" />
                <img src={GeologySaturn} alt="" className="geology" />
              </>
            )}
          </div>
          ...
          <div className="planet-about__container">
            ...
            <div className="planet-overview__source-group">
              <div
                className={`change-planet saturn ${
