...
//         <div className="links">
//           <p><img  src={theme === "dark" ? WhiteLocation : Location} alt="location-icon" /> {user.location || "Not Available"}</p>

//           <p>
//             <img src={theme === "dark" ? WhiteLink : Link} alt="link-icon" />{" "}
//             {user.blog ? (
...
//           <p><img src={theme === "dark" ? WhiteTwitter : Twitter} alt="twitter-icon" /> {user.twitter_username || "Not Available"}</p>

//           <p><img src={theme === "dark" ? WhiteOrganization : Organization} alt="organization-icon" /> {user.company || "Not Available"}</p>
//         </div>
//       </div>
//     </div>
//   );
