...
export default function SignUp() {
  ...
  async function onSubmit(data: any) {
    ...
    try {
      ...
      console.log(error, "ეს ერორი მოდის sign-up -იდან")
    }
  ...
  return (
    <div className='flex justify-center items-center h-screen text-white'>
      <form  onSubmit={handleSubmit(onSubmit)} className='bg-black w[400px]  w-100 h-auto rounded-2xl p-4 flex flex-col gap-4'>
        <input type="text" placeholder='Full Name' className='bg-transparent border-2 border-gray-500 rounded-lg p-2 focus:outline-none focus:border-blue-500' {...register("fullName")} />  
        ...
        <div className='flex justify-center gap-4 bg-white text-black p-2 rounded-lg '>
          ...
          <Link href="/sign-in" className='text-blue-500 cursor-pointer hover:text-blue-700'>Sign In</Link>
        </div>
